...
\begin{enumerate}
	...
	\begin{enumerate}
	\item To register your shoes in the ShoeCase, you need to use the registration function of the app. If you press the 'Register' button, a pop-up window will appear, and the registration will be completed by entering the style code of the shoes. Registered shoes can be found in the "Registered Shoes" window.\\
...
The shoes of another person's ShoeCase found by searching by id are displayed on the screen frame by frame or list. And just below the user id in the upper center, there is a mark indicating the number of kicks and a clicks button that can be pressed. Kicks is a recommended button that you can press when you like someone else's ShoeCase. (similar to a Kick on Instagram). The higher the recommended button, the more popular the person's ShoeCase is. And the other person appears in order of the most attached shoes, and the three shoes in order are marked with 1st 2nd 3rd.\\
