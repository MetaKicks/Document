...
\item[-]Search bar\\
The search bar allows you to enter a name or style code for your shoes. When you search, you will list the shoes you have searched under the search window based on the shoes on the StockX site. When you click on each shoe, you'll see the details of the shoe and the price information by size. You can also click the Add button to add it to your shoecase.\\
\item[-]Mini cards\\
