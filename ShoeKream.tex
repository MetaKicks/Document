...
so we make this service by paying attention to the value of the collection of shoes and checking the fluctuating resell market price in real time using Kream's API, Korea's leading shoe trade site, and sharing each other's collections through this service.
